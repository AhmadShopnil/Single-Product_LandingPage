...
export default function VideoReview() {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      videoUrl: "https://www.youtube.com/watch?v=EXJzcWw75KA",
  ...
  return (
    <section className="py-10 md:py-24 bg-gradient-to-b from-white to-green-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="flex items-center justify-center">
            <div
              className="relative w-full aspect-video bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl overflow-hidden shadow-2xl group cursor-pointer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((review, index) => (
            <div
              ...
              className={`cursor-pointer rounded-2xl overflow-hidden transition-all duration-300 transform ${selectedVideo === index
            ...
            >
              ...
              <div className="relative bg-gray-200 aspect-video flex items-center justify-center overflow-hidden">
                <img
                  ...
                  alt={review.name}
                  className={`w-full h-full object-cover transition-transform duration-300 ${hoveredCard === index ? "scale-110" : "scale-100"
                    }`}
                />
                <div
                  className={`absolute inset-0 bg-black/30 flex items-center justify-center transition-all ${hoveredCard === index ? "bg-black/50" : ""
                    }`}
                >
                  <div
                    className={`w-14 h-14 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center transition-all transform ${hoveredCard === index ? "scale-125 bg-white/40" : ""
                      }`}
                  >
              ...
              {/* Card Info */}
              <div
                className={`p-5 transition-all ${selectedVideo === index
              ...
              >
                ...
                <div className={selectedVideo === index ? "text-yellow-300" : ""}>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="relative w-full max-w-3xl aspect-video bg-black rounded-xl overflow-hidden shadow-2xl">
            {reviews[selectedVideo].videoUrl.includes("youtube.com") ? (
              <iframe
                src={
                  reviews[selectedVideo].videoUrl
                    .replace("watch?v=", "embed/") + "?autoplay=1"
                }
                title={reviews[selectedVideo].name}
              ...
              <video
                src={reviews[selectedVideo].videoUrl}
                controls
                autoPlay
            ...
            <button
              ...
              className="absolute top-3 right-3 bg-white/20 hover:bg-white/40 text-white rounded-full w-10 h-10 flex items-center justify-center text-2xl"
            >
              ✕
            </button>
          </div>
