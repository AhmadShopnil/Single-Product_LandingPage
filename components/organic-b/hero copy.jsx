          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="bg-linear-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700
               text-white font-bold py-3 md:py-4 px-8 rounded-md transition-all duration-300 transform hover:scale-105 shadow-lg
                hover:shadow-xl">
                Buy Now
              </button>
              <button className="border-2 border-green-600 text-green-600 hover:bg-green-50 font-bold  py-2.5 md:py-4
               px-8 rounded-md transition-all duration-300">
                Learn More
              </button>
            </div>
